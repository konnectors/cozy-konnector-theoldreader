...
This is a [theoldreader.com] konnector which gets your bills.
...
*Note:* You need to update the `konnector-dev-config.json` with your login information :
...
git://github.com/laedit/cozy-konnector-theoldreader.git#build
...
theoldreader konnector is developed by laedit and distributed under the [AGPL v3 license][agpl-3.0].
